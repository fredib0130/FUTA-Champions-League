...
export const PLAYERS: Player[] = [
  ...
  { id: 'player-aph-chosen', name: "Chosen", position: "MID" as const, goals: 0, played: 0, cleanSheets: 0, teamId: 'aph', image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=aph-chosen' },
  { id: 'player-aph-onana', name: "Onana", position: "DEF" as const, goals: 0, played: 0, cleanSheets: 0, teamId: 'aph', image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=aph-onana' },
...
export const MATCHES: Match[] = [
  ...
  { id: 'QF1', homeTeam: 'SEED1', awayTeam: 'PO5_WINNER', date: 'Sunday, 12th July, 2026', time: '2:00 PM', venue: 'Mini Pitch', status: 'Finished', homeScore: 1, awayScore: 0, lineupSubmittedHome: true, lineupSubmittedAway: true, matchday: 5, stage: 'Quarter-finals', referee: 'Frank', refereeAssigned: true, matchApproved: true, manOfTheMatch: 'Kolade Farooq' },
...
export const COEFFICIENTS: CoefficientRanking[] = [
  ...
  { rank: 8, teamId: 'ice', teamName: 'Information and Communication Engineering', points2026: 17.00, points2025: 0.00, totalCoefficient: 17.00, isActive: true, movement: '🟢⬆️' },
  { rank: 9, teamId: 'agy', teamName: 'Applied Geology', points2026: 0.00, points2025: 15.00, totalCoefficient: 15.00, isActive: false, movement: '🔴⬇️' },
  ...
  { rank: 13, teamId: 'agp', teamName: 'Applied Geo-Physics', points2026: 11.00, points2025: 0.00, totalCoefficient: 11.00, isActive: true, movement: '🟢⬆️' },
  { rank: 14, teamId: 'ana', teamName: 'Anatomy', points2026: 11.00, points2025: 0.00, totalCoefficient: 11.00, isActive: true, movement: '🟢➡️' },
  { rank: 15, teamId: 'aph', teamName: 'Animal Production and Health', points2026: 11.00, points2025: 0.00, totalCoefficient: 11.00, isActive: true, movement: '🟢⬆️' },
  { rank: 16, teamId: 'idd', teamName: 'Industrial Design', points2026: 11.00, points2025: 0.00, totalCoefficient: 11.00, isActive: true, movement: '🟢⬆️' },
  ...
  { rank: 19, teamId: 'mne', teamName: 'Mining Engineering', points2026: 0.00, points2025: 11.00, totalCoefficient: 11.00, isActive: false, movement: '🔴⬇️' },
  ...
  { rank: 23, teamId: 'rsg', teamName: 'Remote Sensing & GIS', points2026: 0.00, points2025: 8.00, totalCoefficient: 8.00, isActive: false, movement: '🔴⬇️' },
  { rank: 24, teamId: 'sta', teamName: 'Statistics', points2026: 7.00, points2025: 0.00, totalCoefficient: 7.00, isActive: true, movement: '🟢⬆️' },
  { rank: 25, teamId: 'bch', teamName: 'Bio Chemistry', points2026: 6.00, points2025: 0.00, totalCoefficient: 6.00, isActive: true, movement: '🟢⬇️' },
